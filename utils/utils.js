...
function isBuffer(value) {
  return (
    !!value.constructor &&
    typeof value.isBuffer === "function" &&
    value.isBuffer(value)
  );
}
...
function endian(value) {
  if (typeof value === "number") {
    return (
      (0xff00ff & rotateToLeft(value, 8)) |
      (0xff00ff00 & rotateToLeft(value, 24))
    );
  }
...
function calculateHash(
  ...
  const tempValue =
    ...
    constant;
  return (
    ((tempValue << shiftAmount) | (tempValue >>> (32 - shiftAmount))) + value2
  );
}
...
function calculateHash3(
  ...
  const tempValue =
    value1 + (value2 ^ value3 ^ value4) + (value5 >>> 0) + constant;
  return (
    ((tempValue << shiftAmount) | (tempValue >>> (32 - shiftAmount))) + value2
  );
}

function calculateHash4(
  value1,
  value2,
  value3,
  value4,
  ...
  const tempValue =
    value1 + (value3 ^ (value2 | ~value4)) + (value5 >>> 0) + constant;
  return (
    ((tempValue << shiftAmount) | (tempValue >>> (32 - shiftAmount))) + value2
  );
}
